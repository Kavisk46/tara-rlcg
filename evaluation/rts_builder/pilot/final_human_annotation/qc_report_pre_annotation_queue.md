...
## Verdict: PRE-ANNOTATION PASS

(`TO_BE_ASSIGNED` is expected and not counted against this verdict in `pre` mode -- only structural checks gate PRE-ANNOTATION validity.)